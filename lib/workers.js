...
/**
 * Get all the url that is to be monitored
 */
workers.getAllMonitoredUrl = function() {
...
/**
 * Update the url list if there is any changes in db
 */
workers.updateMonitoredUrlList = function(isUpadted) {
    if(isUpadted) {
        workers.getAllMonitoredUrl();
    }
}
...
/**
 * Monitor the urls in every 1 sec
 */
...
/**
 * Save the service log file to db
 */
